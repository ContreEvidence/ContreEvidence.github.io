...
insert = '''<div class="answer-box"><h2>Commencez par le cas qui vous ressemble</h2><div class="decision-grid"><div class="decision-card"><h3>J’ai 10 000 € qui restent longtemps en cash</h3><p>Avec une inflation hypothétique constante de 2 %, 10 000 € ont un pouvoir d’achat équivalent à environ <strong>9 057 € dans 5 ans</strong>, <strong>8 203 € dans 10 ans</strong> et <strong>6 730 € dans 20 ans</strong>.</p></div><div class="decision-card"><h3>Mon salaire augmente moins vite que les prix</h3><p>Si les prix montent de 5 % et votre salaire de 2 %, votre revenu nominal progresse mais votre pouvoir d’achat recule. La bonne comparaison est toujours <strong>revenu après inflation</strong>.</p></div><div class="decision-card"><h3>J’ai un crédit à taux fixe</h3><p>Une mensualité fixe peut devenir relativement moins lourde si les revenus suivent l’inflation. Mais si votre salaire stagne, la hausse des autres dépenses peut au contraire tendre le budget.</p></div><div class="decision-card"><h3>Mon épargne rapporte 2 % et l’inflation est à 3 %</h3><p>Vous gagnez nominalement de l’argent mais perdez du pouvoir d’achat : le rendement réel est approximativement négatif. <strong>Le taux affiché ne suffit pas.</strong></p></div></div><p><a class="btn btn-primary" href="../simulateur-prix-attendre.html">Tester l’effet du temps et de l’inflation sur mes chiffres →</a></p></div>'''
if insert not in s:
