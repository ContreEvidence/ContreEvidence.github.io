...
const BASE_URL = 'https://contreevidence.github.io/';
const RAW_BASE = 'https://raw.githubusercontent.com/ContreEvidence/ContreEvidence.github.io/main/';
...
function slideSvg(heading, sub, index, total) {
  ...
  <text x="82" y="1810" fill="#aeb8be" font-family="Arial,Helvetica,sans-serif" font-size="24">contreevidence.github.io</text>
