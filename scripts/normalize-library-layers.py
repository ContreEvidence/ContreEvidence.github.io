...
# Only executable script consumers are rewritten here. Workflow files are maintained
# directly because the GitHub Actions token cannot update workflow definitions.
files = [Path('scripts/add-related-content.cjs')]
changed = []
for p in files:
