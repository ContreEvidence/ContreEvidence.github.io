# Rapport — contraintes à prouver ou à rouvrir

Ce rapport applique la doctrine : **on ne ferme pas une voie sans preuve ; on ne présente pas non plus une piste comme faisable sans vérification positive.**

Il s’agit d’un filtre heuristique : un signal P0/P1 impose une relecture, pas une correction automatique.
...
- **fermeture forte sans signal de preuve ni périmètre clair** — Sans diplôme → accès supérieur décideur quel obstacle est vraiment obligatoire ?
### `fiches-metiers.html`
...
- **affirmation forte sans signal de source explicite** — Substituez le mode d’apprentissage au lieu d’allonger automatiquement la formation Voir le tableau détaillé Écart réel Substitution à tester connaissance ciblée module court / lecture guidée plutôt que cursus complet. manque de pratique projet, mission ou simulation plutôt qu’heures théoriques supplémentaires. manque de feedback tuteur, pair expert ou revue de travail plutôt qu’un nouveau cours. manque de preuve port _[périmètre]_
- **affirmation forte sans signal de source explicite** — Tester le décideur avant d’investir lourd Quand c’est possible, cherchez une petite preuve de marché avant une formation longue : analyser 30 offres et noter les filtres réellement utilisés ; demander à plusieurs recruteurs quels signaux déclenchent un entretien ; tenter un projet, un test ou une mission limitée ; faire évaluer un portfolio par quelqu’un qui recrute réellement ; vérifier si la certification demandée  _[périmètre, temporalité]_
...
### `dossiers/contrat-travail-clauses-verifier-avant-signer.html`
- **affirmation forte sans signal de source explicite** — Identifier le vrai décideur avant de conclure que « c’est impossible » Le recruteur, le manager, les RH, la direction de la rémunération ou le juridique n’ont pas toujours le même pouvoir de décision. _[périmètre, temporalité]_
...
- **affirmation forte sans signal de source explicite** — Ajoutez la colonne que les tableurs oublient : « qui doit dire oui ? » Hypothèse décideur Risque 45 jours de délai fournisseur fournisseur la trésorerie se dégrade s’il exige comptant. acompte de 30 % client le BFR augmente si le marché refuse. prêt de 30 000 € banque / financeur l’investissement ne peut pas être traité comme acquis. sous-traitance disponible prestataire capacité théorique sans solution opérationnell _[périmètre, temporalité]_
### `dossiers/puis-je-me-permettre-reconversion.html`
- **généralisation d’un acteur privé sans périmètre clair** — Ce qui fait renverser la conclusion Voir le tableau détaillé On pensait… Mais si… Alors… « Il faut une formation de 12 mois » les recruteurs demandent surtout une preuve pratique voie courte / mission / certification ciblée. _[signal-source, temporalité]_
...
- **fermeture forte sourcée mais formulation trop absolue** — Cas E — Candidature directe : la formation ne sert qu’à rassurer Voir le tableau détaillé Offres analysées 30 Diplôme obligatoire 0 Diplôme « souhaité » 9 Expérience équivalente acceptée 21 Compétences transférables déjà prouvées fortes Ici, payer une formation longue avant d’avoir envoyé des candidatures ciblées serait prématuré. _[signal-source, temporalité]_
### `dossiers/trajectoire-professionnelle-selon-situation.html`
...
- **fermeture forte sourcée mais formulation trop absolue** — Droit et éthique : connaître les limites du processus et les critères interdits. _[signal-source]_
### `ingenierie-de-solutions.html`
...
### `articles/50-candidatures-zero-reponse.html`
- **nécessité à requalifier ou sourcer** — 50 candidatures sans réponse : le système doit changer avant le volume Ciblage Les postes visés correspondent-ils réellement au profil et au niveau de preuve disponible ? _[temporalité]_
...
- **nécessité à requalifier ou sourcer** — À retenir : Quand l’intérêt existe déjà, le prochain levier n’est pas toujours plus d’audience : il faut trouver ce qui casse la conversion.
### `articles/competences-transferables.html`
...
- **nécessité à requalifier ou sourcer** — Les conditions qui doivent renverser votre stratégie Voir le tableau détaillé Signal répété Ce qui doit changer 0 entretien sur 20 candidatures ciblées Revenir au ciblage, CV, canal et preuve initiale.
...
- **nécessité à requalifier ou sourcer** — Une interruption n’efface pas votre valeur : elle change ce qu’il faut prouver Point de départ Expliquez la situation actuelle sans laisser l’interruption définir tout le récit.
...
- **nécessité à requalifier ou sourcer** — Définir les seuils d’arrêt Un test ne doit pas seulement avoir un objectif de réussite.
- **nécessité à requalifier ou sourcer** — La documentation doit aussi indiquer quels indicateurs permettent de vérifier que le processus continue à produire le résultat attendu.
...
### `dossiers/apprendre-developper-competences.html`
- **nécessité à requalifier ou sourcer** — Ce qui fait inverser la méthode d’apprentissage Voir le tableau détaillé On privilégierait… Mais si… Alors… autoformation titre réglementaire requis parcours reconnu. pratique immédiate erreur dangereuse simulation / encadrement d’abord. formation longue écart très ciblé parcours court. certification décideur valorise surtout les réalisations construire preuve et expérience. portfolio filtre automatique ou réglementa
- **nécessité à requalifier ou sourcer** — Le niveau de preuve doit donc correspondre à la décision que le décideur doit prendre.
### `dossiers/audit-budget-60-minutes.html`
...
- **nécessité à requalifier ou sourcer** — Elle ne doit pas disparaître du bilan simplement parce qu’elle n’a pas de cours quotidien.
...
### `dossiers/indivision-immobiliere-sortir-sans-subir.html`
- **nécessité à requalifier ou sourcer** — Conditions de renversement Voir le tableau détaillé Choix provisoire Information qui doit rouvrir la décision Rachat total Banque ne libère pas l’autre coemprunteur.
...
- **nécessité à requalifier ou sourcer** — Format de conclusion Scénario : ce qui doit se produire.
- **nécessité à requalifier ou sourcer** — Il faut comprendre d’où elle vient, combien de capital elle consomme et ce qu’il reste en cash .
- **nécessité à requalifier ou sourcer** — La valorisation doit relier prix, croissance, marges, capital nécessaire et rendement attendu.
- **nécessité à requalifier ou sourcer** — Les données de marché, les résultats d’entreprise et les conditions financières évoluent ; toute analyse appliquée doit être datée et sourcée.
- **nécessité à requalifier ou sourcer** — Risque : transformer la thèse en taille de position La conviction ne doit jamais déterminer seule la taille.
- **nécessité à requalifier ou sourcer** — Son niveau doit donc être une décision d’allocation, pas le résidu de l’indécision.
- **nécessité à requalifier ou sourcer** — Une marge record obtenue dans un environnement exceptionnel ne doit pas être extrapolée automatiquement. _[temporalité]_
...
- **nécessité à requalifier ou sourcer** — Le prévisionnel doit déclencher des décisions, pas constater après coup Voir le tableau détaillé Indicateur Seuil illustratif Action Taux de conversion < 10 % après 100 prospects qualifiés revoir cible/offre avant d’augmenter l’acquisition. _[temporalité]_
...
### `dossiers/quand-vie-change-sante-separation-revenu.html`
- **nécessité à requalifier ou sourcer** — Ce qui doit faire renverser une décision provisoire Voir le tableau détaillé Décision provisoire Signal de renversement Conserver le logement le coût mensuel rend le durée de sécurité trop court ou aucune issue durable n’apparaît. _[temporalité]_
...
- **nécessité à requalifier ou sourcer** — Ce qui fait renverser la conclusion Voir le tableau détaillé On pensait… Mais si… Alors… « Il faut plus prospecter » 50 % des rendez-vous achètent oui : le volume est probablement le goulot.
...
### `index.html`
- **nécessité à requalifier ou sourcer** — Ouvrir une fenêtre → Quand quelque chose doit changer Les décisions où travail, argent et qualité de vie se rencontrent.
- **nécessité à requalifier ou sourcer** — Premier emploi, retour à l’emploi, reconversion, offre, contrat, salaire, management ou activité indépendante : partez de la situation qui doit réellement changer.
### `ingenierie-de-solutions.html`
- **nécessité à requalifier ou sourcer** — Il faut explorer, vérifier, recombiner, tester, puis seulement conclure.
- **nécessité à requalifier ou sourcer** — Une contrainte doit être qualifiée avant d’être acceptée Type Ce que cela signifie Question Absolue Un texte, un fait matériel ou un calcul ferme réellement la voie. _[temporalité]_
...
- **nécessité à requalifier ou sourcer** — Horizon final de comparaison ans Doit être supérieur à la durée du report. _[temporalité]_
### `simulateur-prix-minimum-rentable.html`
- **nécessité à requalifier ou sourcer** — Outil d’application · Vie professionnelle · Entrepreneuriat Calculer son prix minimum rentable Partez de ce que l’activité doit produire chaque mois et du nombre d’heures réellement disponibles pour exécuter les missions.
...
Pour chaque signal :
1. Qui impose réellement la contrainte ?
2. Quel texte, contrat, calcul ou fait le prouve ?
3. La contrainte est-elle absolue, locale, temporaire, quantitative, relationnelle ou séquentielle ?
4. Quel changement de date ou d’ordre des opérations peut modifier la réponse ?
5. Si aucune impossibilité n’est démontrée, la voie passe en **À TESTER**, jamais directement en **VÉRIFIÉE**.
6. Si une piste paraît fonctionner, quelles preuves positives manquent encore avant de la recommander ?
